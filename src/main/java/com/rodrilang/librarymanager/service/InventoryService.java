...
public interface InventoryService {
    ...
    Page<InventorySummaryResponse> find(String query, boolean force, InventoryStockFilter stockFilter, Pageable pageable);

    InventoryStockSummaryResponse getStockSummary();
